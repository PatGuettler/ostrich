...
```bash
godot --path /home/pat/dev/dashers/ostrich-dash
...
```bash
godot --headless --fixed-fps 60 --path /home/pat/dev/dashers/ostrich-dash --script res://tests/smoke_test.gd
```
...
```bash
godot --fixed-fps 60 --path /home/pat/dev/dashers/ostrich-dash --script res://tests/art_capture.gd
```
...
```bash
godot --fixed-fps 60 --path /home/pat/dev/dashers/ostrich-dash --script res://tests/art_capture.gd -- --powers-only
```

Rebuild the Google Play screenshot galleries from direct in-game captures with:

```bash
godot --fixed-fps 60 --path /home/pat/dev/dashers/ostrich-dash --script res://tests/art_capture.gd -- --store-listing
...
```bash
godot --path /home/pat/dev/dashers/ostrich-dash -- --preview-ad-bar
```
