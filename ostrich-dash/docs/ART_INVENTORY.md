...
| Jump/duck | Rigid sprite lift/squash that appeared to pass through hazards | Dedicated transparent rear-view avoidance poses: the jump tucks both feet fully above the hurdle and leaves a planted shrinking ground shadow; the duck bends both knees, plants both shoes, and folds the long neck into a pronounced S-curve beneath the gate. The duck plate is compressed around its planted shoe line and flying hazards hover above that visible profile. The ordinary six-frame run legs are hard-hidden and frozen for the full jump/duck, so duplicate or cycling limbs cannot show, while the collision capsule changes with the visible pose. |
